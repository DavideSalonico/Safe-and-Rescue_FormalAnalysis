...
class Grid:
    def __init__(self, rows, cols, n_exits, n_fires, n_civilians, n_frs, t_zr, t_fr, t_v, n_drones, n_v):
        ...
        self.__fill_random_cells__(n_frs, 8)
    ...
    def generateDeclarations(self):
        ...
        declarations += "int grid[GRID_LENGTH][GRID_HEIGHT] = " + self.gridDeclaration() + "\n"
        declarations += "\n// Global arrays\n\n"
        declarations += "pos_t drone_trajectories[N_DRONES][MAX_TRAJ] = " + self.droneDeclaration() + "\n"
